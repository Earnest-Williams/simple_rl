...
This component is designed to provide the AI logic for hostile/adventuring NPCs interacting within the dungeon environments generated by `Dungeon/`. The exact integration points with the main game loop and other systems (like perception from `pathfinding/`) are still under development.
