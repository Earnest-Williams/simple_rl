...
| Community AI | `ai/`, `game/ai/community*.py`, `docs/ADR/0002-ai-boundaries.md` | R&D | See `ai/README.md` | Advanced community behavior is not fully integrated into main gameplay | Promote features into `game/ai/` through focused, tested integration patches. |
| Lighting/FOV R&D | `lights_dev/`, `docs/ADR/0004-perception-fov-boundaries.md` | R&D | `cd lights_dev && python main_game.py` | Experimental; production rendering lives in `engine/` and `game/world/` | Graduate algorithms only through tested production patches. |
...
| Notes and scratch material | `notes/`, `docs/DEPRECATION_POLICY.md` | Historical | None | Not production documentation | Retain only while useful content is migrated into curated docs or issues. |
