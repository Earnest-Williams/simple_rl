...
| Overland generation | `worldgen/overland/`, `tools/generate_overland.py`, `tools/inspect_overland.py` | Evolving integrated subsystem | `python tools/generate_overland.py --help` | Overland-first terrain, connected hydrology, starting-region contract, route, transition handoff, affordance, and settlement-merge contract; planning source is `docs/Overland Roadmap.md` | Site-history and evidence tags are the next implementation slice. |
