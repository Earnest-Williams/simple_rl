...
def run_regression(
    *,
    ...
    original_max_turns_sim = auto_simulation.MAX_TURNS
    original_max_turns_main = auto_main.MAX_TURNS
    ...
    try:
        ...
        auto_simulation.MAX_TURNS = original_max_turns_sim
        auto_main.MAX_TURNS = original_max_turns_main
