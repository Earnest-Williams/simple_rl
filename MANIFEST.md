...
| File | Purpose | Imports | Constants/Magic Numbers |
|------|---------|---------|------------------------|
| `tests/test_fov.py` | Unit tests for production FOV computation verifying shadowing and visibility | `numpy`, `game.world.fov` via fixtures | Grid sizes: 11, 21, 15<br>Radii: 3, 6, 10, 12<br>Coordinate offsets |
...
| `bench/bench_fov.py` | Performance benchmark for production FOV computation with random wall obstacles | `time`, `numpy`, `game.world.fov`, `utils.game_rng` | WALL_DENSITY_DIVISOR - 10<br>WARMUP_RUNS - 3<br>Defaults: grid 200×200, radius 20, trials 50 |
